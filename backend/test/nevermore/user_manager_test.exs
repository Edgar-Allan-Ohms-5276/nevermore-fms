defmodule Nevermore.UserManagerTest do
  use Nevermore.DataCase

  alias Nevermore.UserManager

  describe "users" do
    alias Nevermore.UserManager.User

    @valid_attrs %{notes: "some notes", password: "some password", permissions: [], username: "some username"}
    @update_attrs %{notes: "some updated notes", password: "some updated password", permissions: [], username: "some updated username"}
    @invalid_attrs %{notes: nil, password: nil, permissions: nil, username: nil}
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.notes == "some updated notes"
